...
def applyDamage(attacker, defender):
    ...
    if defender.units <= 0:
        return True, unitsLost
    else:
        return False, unitsLost
...
while True:
    ...
    winner, armies = playGame(immunes, infections, boost)
    #print winner, armies, boost
    if winner == 'immune':
        print armies
        break
